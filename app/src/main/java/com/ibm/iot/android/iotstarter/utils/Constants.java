...
public class Constants {
    ...
    public final static String STEP_EVENT = "step";
    public final static String SCREEN_EVENT = "screen";
    public final static String NOISE_EVENT = "noise";
    ...
    public final static String FRE_EVENT = "fre";
