...
public class MessageFactory {
    ...
    public static String getStep(float step,String deviceMovement,String userMovement) {
        return "{\"d\":{" +
                "\"Step\":\"" + step + "\", " +
    ...
    public static String getScreen(String screenState) {
        return "{\"d\":{" +
                "\"ScreenState\":\"" + screenState + "\"" +
                " } }";
    }

    public static String getNoise(double noise,String state) {
        return "{\"d\":{" +
                "\"NoiseLevel\":\"" + noise + "\"," +
                "\"NoiseState\":\"" + state + "\"" +
                " } }";
