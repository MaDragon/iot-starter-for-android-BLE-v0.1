...
public class IoTPagerFragment extends IoTStarterPagerFragment {
    ...
    private void processAccelEvent() {
        ...
        int ff=app.getFfe();
        float step =app.getStepNum();
        double noise =app.getNoiseDate();
        ...
        ((TextView) getActivity().findViewById(R.id.ff)).setText("Sampling: " + ff);
        ((TextView) getActivity().findViewById(R.id.step)).setText("Step: " + step);
        ((TextView) getActivity().findViewById(R.id.noise)).setText("Noise: " + noise+" dB");
        ((TextView) getActivity().findViewById(R.id.device)).setText("device: " + app.getStateDeviceMovement());
        ((TextView) getActivity().findViewById(R.id.user)).setText("user: " + app.getStateUserMovement());
