...
import com.ibm.iot.android.iotstarter.utils.ScreenStateReceiver;
...
public class IoTStarterApplication extends Application {
    ...
    public static double amplitudeDb;
    ...
    private String screenData=null;
    ...
    public void setStateDeviceMovement(String stateDeviceMovement) {
        this.stateDeviceMovement = stateDeviceMovement;
    }
    ...
    public void setStateUserMovement(String stateUserMovement) {
        this.stateUserMovement = stateUserMovement;
    }

    private String stateUserMovement;

    public String noiseLvl;
    private Timer timer;
    ...
    public void onCreate() {
        ...
        ScreenStateReceiver lockScreenReceiver = new ScreenStateReceiver();
        ...
        mRecorder.start();
//        float audiometers = mRecorder.getMaxAmplitude();
//            double amplitudeDb = 20 * Math.log10((double)Math.abs(audiometers));
////
//            Log.d("223SSS", String.valueOf(amplitudeDb));
        timer=new Timer();

        timer.scheduleAtFixedRate(new SendTimerTask(mRecorder), 1000, 1000);
////        String screen= lockScreenReceiver.getScreenState();
//        Log.d("SSSS",screen);
//        if(screen!=null){
//            Log.d("SSSSS",screen);
//        }
...
//                iotClient.publishEvent(Constants.NOISE_EVENT, "json", "{\"d\":{" +
//                        "\"ScreenState\":\"" + String.valueOf(amplitudeDb) + "\"" +
//                        " } }", 0, false, listener);
//
